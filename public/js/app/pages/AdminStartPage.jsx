...
import { ADMIN_COURSE_UTV, ADMIN_COURSE_PM, ADMIN_COURSE_PM_DATA, ADMIN_OM_COURSE, PM_TEMPLATE } from '../util/constants'
  ...
  render () {
    ...
    return (
      <div key='kursinfo-container' className='kursinfo-main-page col' >
        ...
        <div className='col'>
          <span className={isPilotCourse ? 'AdminPage--ShowDescription--PilotCourse' : 'AdminPage--ShowDescription'}>
            ...
            {isPilotCourse && (
              <Card className='Skapa--Kurs-PM'>
                <CardBody>
                  <CardTitle><h4>{startCards.coursePM_hd} <Badge color="success">New</Badge></h4></CardTitle>
                  <CardText>
                ...
                <CardFooter className='text-right'>
                  <span>
                    <CardLink href={`${ADMIN_COURSE_PM_DATA}${courseCode}?l=${lang}`} className='btn btn-primary' alt={startCards.coursePM_btn_new}>
                      {startCards.coursePM_btn_new}
                    </CardLink>
                    <CardLink href={`${ADMIN_COURSE_PM_DATA}published/${courseCode}?l=${lang}`} className='btn btn-primary' alt={startCards.coursePM_btn_edit}>
                      {startCards.coursePM_btn_edit}
                    </CardLink>
                  </span>
                  <span>
                    <CardLink href={PM_TEMPLATE} alt={startCards.coursePM_link_template} target="_blank" className="external-link">
                      {startCards.coursePM_link_template}
                    </CardLink>
                  </span>
                </CardFooter>
              </Card>
