        ...
        <div className='col'>
          <span className='AdminPage--ShowDescription'>
            ...
            <Card>
              ...
              <CardFooter className='text-right'>
                <a href={`${ADMIN_COURSE_PM_DATA}${courseCode}?l=${lang}`} className='btn btn-primary' alt={startCards.coursePM_btn_new}>
                  {startCards.coursePM_btn_new}
                </a>
                <a href={`${ADMIN_COURSE_PM_DATA}published/${courseCode}?l=${lang}`} className='btn btn-primary' alt={startCards.coursePM_btn_edit}>
