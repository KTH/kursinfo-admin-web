...
const devAnalysesStorageUri = devDefaults(
  'https://kursinfostoragestage.blob.core.windows.net/kursutveckling-blob-container/'
)
...
module.exports = {
  ...
  analysesStorageUri: getEnv('ANALYSES_STORAGE_URL', devAnalysesStorageUri),
}
