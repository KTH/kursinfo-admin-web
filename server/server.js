...
appRoute.get('course.editDescription', config.proxyPrefixPath.uri + '/picture/:courseCode', serverLogin, requireRole('isCourseResponsible', 'isExaminator', 'isSuperUser'), SellingInfo.getDescription)
...
// appRoute.post('storage.saveFile', config.proxyPrefixPath.uri + '/storage/saveFile/:analysisid/:type/:published', AdminPagesCtrl.saveFileToStorage)
// appRoute.post('storage.updateFile', config.proxyPrefixPath.uri + '/storage/updateFile/:fileName/', AdminPagesCtrl.updateFileInStorage)
// appRoute.post('storage.deleteFile', config.proxyPrefixPath.uri + '/storage/deleteFile/:id', AdminPagesCtrl.deleteFileInStorage)
