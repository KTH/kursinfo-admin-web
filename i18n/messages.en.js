...
module.exports = {
  ...
  startCards: {
    ...
    coursePM_create_desc_p3:
      'It is also possible to use the function: Upload or edit course memo as a PDF, to publish a course memo created outside the tool at About course. The file you upload must be in PDF format and meet web accessibility guidelines.',
