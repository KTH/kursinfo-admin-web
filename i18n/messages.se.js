...
module.exports = {
  ...
  startCards: {
    ...
    coursePM_create_desc_p3:
      'Du kan även välja att ladda upp och publicera ett kurs-PM som du har skapat utanför systemstödet, via funktionen: Ladda upp eller ändra kurs-PM som PDF. Filen du publicerar måste vara i PDF-format och tillgänglighetsanpassad.',
